...
In this section, we detail the architecture and design of \verb|jax-unirep|.
...
thus achieving at least two order of magnitudes speed-up
over the original implementation.
...
In particular, our test suite covers over 95\% of the codebase;
...
that can be \it{modularly} incorporated
into a computational protein engineer's workflow,
with easily copy-pasteable code provided for end-user ease.
